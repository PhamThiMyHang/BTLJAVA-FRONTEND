...
export default function ServicesPage() {
  ...
  // ─── Fetch ban đầu: lấy toàn bộ dịch vụ ───────────────
  useEffect(() => {
  ...
  // ─── Trigger search khi keyword / giá / category đổi ──
  useEffect(() => {
    if (!loading) {
      fetchSearch(searchKeyword, selectedPriceRange, selectedCategory);
    }
  }, [searchKeyword, selectedPriceRange, selectedCategory, loading]);
